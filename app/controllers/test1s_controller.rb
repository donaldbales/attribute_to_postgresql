class Test1sController < ApplicationController
  ...
  private
    ...
    def test1_params
      params.require(:test1).permit(:attribute_binary, :attribute_boolean, :attribute_date, :attribute_datetime, :attribute_decimal, :attribute_float, :attribute_integer, :attribute_string, :attribute_text, :attribute_time)
    end
end
