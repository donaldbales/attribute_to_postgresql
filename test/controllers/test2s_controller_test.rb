...
class Test2sControllerTest < ActionController::TestCase
  ...
  test "should create test2" do
    assert_difference('Test2.count') do
      post :create, test2: { attribute_timestamp_wotz: @test2.attribute_timestamp_wotz, attribute_timestamp_wtz: @test2.attribute_timestamp_wtz }
    end
  ...
  test "should update test2" do
    patch :update, id: @test2, test2: { attribute_timestamp_wotz: @test2.attribute_timestamp_wotz, attribute_timestamp_wtz: @test2.attribute_timestamp_wtz }
    assert_redirected_to test2_path(assigns(:test2))
  end
